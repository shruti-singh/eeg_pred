...
def get_matfiles(task:str, subdir = '/home/singh_shruti/ZuCo_dataset/'):
    """
        Args: Task number ("task1", "task2", "task3") plus sub-directory
        Return: 12 matlab files (one per subject) for given task
    """
    task_suffix = {"task1": "_sr", "task2": "_nr", "task3": "_tsr"}
#     path = os.getcwd() + subdir + task + task_suffix[task]
    path = subdir + task + task_suffix[task] + "/Matlab files/"
